...
$pending_posts          = (class_exists("WPQA") && wpqa_is_pending_posts() && ($is_super_admin || $active_moderators == "on") && wpqa_is_user_owner() && ($is_super_admin || (isset($moderator_categories) && is_array($moderator_categories) && !empty($moderator_categories)))?true:false);
$pending_posts_page     = (class_exists("WPQA") && wpqa_is_pending_posts()?true:false);
	...
	<div class="single-inner-content">
		...
		<?php if (!is_page_template("template-users.php") && !is_page_template("template-contact.php") && !is_page_template("template-faqs.php") && !is_page_template("template-categories.php") && !is_page_template("template-tags.php")) {?>
			<footer<?php echo ($pending_posts?" class='pending-post-footer'":"")?>>
				...
				if (class_exists("WPQA") && wpqa_plugin_version >= 3.9 && $pending_posts) {
