					...
					<?php }else {
						...
						<div class="user-login-area<?php echo ($active_notifications == "on"?"":" no-notifications")?>">
							...
							if ($header_user_login == "on") {
								...
								if (class_exists("WPQA") && ($is_super_admin || $active_moderators == "on") && ((isset($user_login_links["pending-questions"]["value"]) && $user_login_links["pending-questions"]["value"] == "pending-questions") || (isset($user_login_links["pending-posts"]["value"]) && $user_login_links["pending-posts"]["value"] == "pending-posts"))) {
										...
										if (isset($first_one) && $first_one !== "") {
											...
											<ul>
												<?php foreach ($user_login_links as $key => $value) {
													...
													<?php }else if ($subscriptions_payment == "on" && $key == "subscriptions" && isset($user_login_links["subscriptions"]["value"]) && $user_login_links["subscriptions"]["value"] == "subscriptions" && class_exists("WPQA")) {
