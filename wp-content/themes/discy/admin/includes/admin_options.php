	...
	function options_page() {?>
		<div id="discy-admin-wrap" class="discy-admin">
			...
			if ($max_input_vars < 4000) {
				echo '<div class="alert-message alert-message-error">'.sprintf(esc_html__('Your value %1$s - Recommended Value: %2$s. Max input vars limitation will truncate POST data such as options. See %3$sIncreasing max input vars limit.%4$s You must increase to can save options.','discy'),$max_input_vars,"4000","<a href='https://2code.info/docs/discy/max_input_vars/' target='_blank' rel='noopener noreferrer'>","</a>").'</div>';
			}?>
