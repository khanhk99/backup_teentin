...
function discy_admin_author($user_id = "") {
	...
	if (!is_super_admin($user_id) && $active_moderators == "on") {
		...
		$options[] = array(
			'name'        => esc_html__('Choose the question categories you need this user to moderator it.','discy'),
		...
		$options[] = array(
			'name'        => esc_html__('Choose the post categories you need this user to moderator it.','discy'),
