(function($) {
	...
	/* Comments and answers links */
	var link = 'edit-comments.php?comment_status='+option_js.comment_status;
	if (option_js.comment_status != "") {
		jQuery('#menu-comments .wp-submenu-wrap li').each(function() {
