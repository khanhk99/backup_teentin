	...
	function wpqa_redirect_pages() {
		...
		if (wpqa_is_user_profile()) {
			if (get_option('permalink_structure')) {
				...
				if ($user_name != $wpqa_user || (isset($_GET['wpqa_user_id']) && $_GET['wpqa_user_id'] > 0 && $_GET['wpqa_user_id'] == $wpqa_user_id)) {
		...
		if (wpqa_is_search()) {
			if (get_option('permalink_structure') && (!empty($_GET['search']) || !empty($_GET['s']) || !empty($_GET['search_type']))) {
...
if (!function_exists('wpqa_rewrite_rules')) :
	function wpqa_rewrite_rules() {
		...
		$search_root_rule = $subscriptions_root_rule = $buy_points_root_rule = $login_root_rule = $signup_root_rule = $lost_password_root_rule = $add_category_root_rule = $add_questions_root_rule = $edit_questions_root_rule = $add_posts_root_rule = $edit_posts_root_rule = $edit_comments_root_rule  = '/?$';
...
if (!function_exists('wpqa_template_include')) :
	function wpqa_template_include ($new_template) {
		...
		if (wpqa_is_user_profile() || wpqa_is_search() || wpqa_is_subscriptions() || wpqa_is_buy_points() || wpqa_is_login() || wpqa_is_signup() || wpqa_is_lost_password() || wpqa_is_add_category() || wpqa_is_add_questions() || wpqa_is_edit_questions() || wpqa_is_add_posts() || wpqa_is_edit_posts() || wpqa_is_edit_comments() || $wpqa_template_filter == true) {
			global $wp_query;
...
if (!function_exists('wpqa_parse_query')) :
	function wpqa_parse_query($posts_query) {
		...
		if ( !empty( $is_user ) || isset($posts_query->query_vars[apply_filters('wpqa_search_id','search')]) || isset($posts_query->query_vars[apply_filters('wpqa_subscriptions','wpqa_subscriptions')]) || isset($posts_query->query_vars[apply_filters('wpqa_buy_points','wpqa_buy_points')]) || isset($posts_query->query_vars[apply_filters('wpqa_login','wpqa_login')]) || isset($posts_query->query_vars[apply_filters('wpqa_signup','wpqa_signup')]) || isset($posts_query->query_vars[apply_filters('wpqa_lost_password','wpqa_lost_password')]) || isset($posts_query->query_vars[apply_filters('wpqa_add_categories','add_category')]) || isset($posts_query->query_vars[apply_filters('wpqa_add_questions','add_question')]) || isset($posts_query->query_vars[apply_filters('wpqa_edit_questions','edit_question')]) || isset($posts_query->query_vars[apply_filters('wpqa_add_posts','wpqa_add_post')]) || isset($posts_query->query_vars[apply_filters('wpqa_edit_posts','edit_post')]) || isset($posts_query->query_vars[apply_filters('wpqa_edit_comments','edit_comment')]) ) {
		...
		}elseif ( isset($posts_query->query_vars[apply_filters('wpqa_subscriptions','wpqa_subscriptions')]) ) {
...
function wpqa_the_title($title) {
	if (wpqa_is_search()) {
		...
		$title['title'] = esc_html__('Subscriptions','wpqa');
	}else if (wpqa_is_buy_points()) {
