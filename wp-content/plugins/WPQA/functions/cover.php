			...
			<div class='wpqa-cover-inner".($cover_fixed == "fixed"?"":" discy-container")."'>
				<div class='wpqa-cover-content'>
					...
					<div class='wpqa-cover-right'>";
						...
						if ($owner || ($active_moderators == "on" && isset($if_user_id->roles[0]) && $if_user_id->roles[0] != "administrator" && $pending_posts == true && ($is_super_admin || (isset($moderators_permissions['ban']) && $moderators_permissions['ban'] == "ban")))) {
							...
							echo "<div class='question-list-details'>
								...
								<ul class='question-link-list'>";
									...
									if ($active_moderators == "on" && isset($if_user_id->roles[0]) && $if_user_id->roles[0] != "administrator" && $pending_posts == true && ($is_super_admin || (isset($moderators_permissions['ban']) && $moderators_permissions['ban'] == "ban"))) {
