...
/* Registration save */
add_action('user_register','wpqa_register_welcome',2,1);
add_action('wpqa_register_welcome','wpqa_register_welcome',1,1);
if (!function_exists('wpqa_register_welcome')) :
...
if (!function_exists('wpqa_signup_in_popup')) :
	function wpqa_signup_in_popup() {
		return esc_html__( 'Need An Account,', 'wpqa' ).' <a href="'.wpqa_signup_permalink().'" class="signup-panel'.apply_filters('wpqa_pop_up_class_signup','').'">'.esc_html__( 'Sign Up Here', 'wpqa' ).'</a>';
	}
endif;
