										...
										$out .= '<div class="page-section page-section-'.$value_sections["value"].'">
											<div class="page-wrap-content">
												...
												foreach ($edit_profile_items_4 as $key_items_4 => $value_items_4) {
													...
													}else if ($key_items_4 == "new_payment_mail" && isset($value_items_4["value"]) && $value_items_4["value"] == "new_payment_mail" && ($pay_ask == "on" || $pay_to_sticky == "on" || $subscriptions_payment == "on" || $buy_points_payment == "on" || $pay_to_answer == "on" || $pay_to_anything == true)) {
